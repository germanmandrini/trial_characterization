...
make_yearly_summary <- function(file_n){
  ...
  if(!inherits(possibleError, "error")){
    ...
    save_dir <- paste0("./trial_characterization_box/Data/yc_output_summary_", batch_n, '_', water_n)
...
# files_daily <- list.files('S:/Bioinformatics Lab/germanm2/trial_characterization/yc_output',full.names = T, recursive = T)
# files_daily <- list.files('./trial_characterization_box/Data/yc_output',full.names = T, recursive = T)
