...
#---------------------------------------------------------------
# Step 1 Get the soils for each field (MAKE IT BETTER, 
# SEQUENTIAL (PARALELL DOESN'T WORK, NOT BY TILE, PUT WHILE STATEMENT AND A TRY))
...
for(tile_n in c(22,23)){
  ...
  source('./trial_characterization_box/Data/APssurgo_master/R/get_soils_parallel.R')
...
saveRDS(grid10_soils_list, "./trial_characterization_box/Data/Grid/grid10_soils_list.rds")
...
source('./trial_characterization_box/Data/APssurgo_master/R/get_soils_seq.R')
...
saveRDS(grid10_soils_sf2, "./trial_characterization_box/Data/Grid/grid10_soils_sf2.rds")
grid10_soils_sf2 <- readRDS("./trial_characterization_box/Data/Grid/grid10_soils_sf2.rds")

#---------------------------------------------------------------  
# Clean the soils (replace small areas by biggest)
source('./trial_characterization_git/Codes/clean_fields_step1.R')
grid10_soils_dt3 <- readRDS("./trial_characterization_box/Data/Grid/grid10_soils_dt3.rds")
length(unique(grid10_soils_dt3$mukey)) #total soils to download

#---------------------------------------------------------------  
# Step 2 get the horizons information
source('./trial_characterization_box/Data/APssurgo_master/R/get_horizons_parallel.R')
grid10_horizons_v1_dt <- readRDS("./trial_characterization_box/Data/Grid/grid10_horizons_v1_dt.rds")


# Clean the soils not available in SSURGO
source('./trial_characterization_git/Codes/clean_fields_step2.R')
grid10_soils_dt4 <- readRDS("./trial_characterization_box/Data/Grid/grid10_soils_dt4.rds")
grid10_fields_sf2 <- readRDS("./trial_characterization_box/Data/Grid/grid10_fields_sf2.rds")
...
# saveRDS(grid10_horizons_v2_dt, "./trial_characterization_box/Data/Grid/grid10_horizons_v2_dt.rds")
# grid10_horizons_v2_dt <- readRDS("./trial_characterization_box/Data/Grid/grid10_horizons_v2_dt.rds")
#---------------------------------------------------------------
...
saveRDS(regions_horizons_dt, "./trial_characterization_box/Data/Grid/regions_horizons_dt.rds")

#---------------------------------------------------------------
grid10_soils_dt4 <- readRDS("./trial_characterization_box/Data/Grid/grid10_soils_dt4.rds")

grid10_soils_dt4_old <- readRDS("./trial_characterization_box/Data/Grid/grid10_soils_dt4_old.rds")
...
saveRDS(grid10_soils_dt4, "./trial_characterization_box/Data/Grid/grid10_soils_dt4_difference.rds")
